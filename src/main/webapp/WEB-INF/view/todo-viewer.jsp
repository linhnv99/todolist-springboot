		...
		<div class="widget-content p-0">
			<div class="widget-content-wrapper">
				<div class="widget-content-left mr-2">
					<div class="custom-checkbox custom-control ">
						<input class="custom-control-input js-checkbox"
							id="checkbox${todo.id }" type="checkbox" onclick="toggleCompleted(${todo.id})"
				...
				<div class="widget-content-left">
					<div class="widget-heading ${todo.completeStatus ? 'line-through' : '' }" >${todo.name }</div>
				...
				<div class="widget-content-right " style="position: relative;">
					...
					<div class="control-setting">
						...
						<a href="javascript:void(0)" class="editTodo"
							...
							href="javascript:void(0)"  onclick="deleteTodo(${todo.id})"><i
